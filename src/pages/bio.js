...
const BioPage = () => (
  <div className={s.bioPageWrap}>
    ...
    <p>EMMY AWARD Winning director/choreographer Bonnie Story is one of the country’s most in demand dance makers, whose work has repeatedly been featured on the hit FOX dance show "So You Think You Can Dance".</p>
